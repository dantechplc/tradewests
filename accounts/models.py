...
class Client(models.Model):
    ...
    referral_Link = models.CharField(max_length=500, null=True, blank=True)
    def __str__(self):
    ...
    def save(self, *args, **kwargs):
        ...
        self.referral_Link = f"{domain}/account/sign-up?ref={self.referral_code}"
...
class Account(models.Model):
    ...
    first_deposit = models.BooleanField(blank=True, null=True, default=False)
...
class Investment(models.Model):
    name = models.CharField(max_length=200)
    category = models.ForeignKey(InvestmentCategory, related_name='investment', null=True, on_delete=models.CASCADE)
    ...
    roi_rate = models.CharField(blank=True, null=True, max_length=200)
    ...
    def save(self, *args, **kwargs):
        """
        Automatically calculate daily ROI on save
        """
...
class InvestmentBenefits(models.Model):
